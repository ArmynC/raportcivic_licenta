    ...
    QObject {
        ...
        function initScreenLayout() {
            if (screenLayout == null) {
                ...
                screenLayout.x = control.layoutX
            ...
            Column {
                ...
                move: Transition {
                    NumberAnimation {
                        ...
                        duration: QTheme.animationEnabled ? 333 : 0
                    }
                }
            ...
            Row {
                ...
                QIcon {
                    iconSource: {
                        switch (_super.type) {
                        case mcontrol.const_success:
                            return FluentIcons.CompletedSolid
                        case mcontrol.const_warning:
                            return FluentIcons.InfoSolid
                        case mcontrol.const_info:
                            return FluentIcons.InfoSolid
                        case mcontrol.const_error:
                            return FluentIcons.StatusErrorFull
                        }
