...
Item {
    ...
    property int closeButtonVisibility : QTabViewType.Always
        ...
        delegate:  Item{
            ...
            Item{
                ...
                Item{
                    ...
                    width: {
                        if(tabWidthBehavior === QTabViewType.Equal){
                            return Math.max(Math.min(d.maxEqualWidth,tab_nav.width/tab_nav.count),41 + item_btn_close.width)
                        }
                        if(tabWidthBehavior === QTabViewType.SizeToContent){
                            return itemWidth
                        }
                        if(tabWidthBehavior === QTabViewType.Compact){
                    ...
                    QIconButton {
                        ...
                        height: 24
                        visible: {
                            if (control.closeButtonVisibility === QTabViewType.Never)
                                return false
                            if (control.closeButtonVisibility === QTabViewType.OnHover)
