...
QButton {
    ...
    property string yearText: qsTr("Anul")
    property string monthText: qsTr("Luna")
    property string dayText: qsTr("Ziua")
                            ...
                            Rectangle{
                                ...
                                color:  {
                                    if(getListView().currentIndex === position){
                                        return  item_mouse.containsMouse ? Qt.lighter(QTheme.primaryColor,1.1): QTheme.primaryColor
                                    }
