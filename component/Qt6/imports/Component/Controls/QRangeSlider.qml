...
T.RangeSlider {
    ...
    first.handle: Rectangle {
        ...
        implicitHeight: 20
        radius: width / 2
        color:QTheme.dark ? Qt.rgba(69/255,69/255,69/255,1) :Qt.rgba(1,1,1,1)
        QShadow{
            radius: 10
        }
        QIcon{
    ...
    background: Item {
        ...
        Rectangle{
            ...
            anchors.margins: 1
            radius: 2
            color:QTheme.dark ? Qt.rgba(162/255,162/255,162/255,1) : Qt.rgba(138/255,138/255,138/255,1)
        }
        Rectangle {
