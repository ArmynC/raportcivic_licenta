    ...
    ListView{
        ...
        remove: Transition {
            NumberAnimation {
                ...
                from: 1
                to: 0
                duration: QTheme.animationEnabled ? 83 : 1
            }
        }
        add: Transition {
            NumberAnimation {
                ...
                QText{
                    ...
                    color: {
                        if(item_mouse.pressed){
                            return QTheme.dark ? Qt.rgba(150/255,150/255,150/235,1) : Qt.rgba(134/255,134/255,134/235,1)
                        }
                        if(item_mouse.containsMouse){
                            return QTheme.dark ? Qt.rgba(204/255,204/255,204/235,1) : Qt.rgba(92/255,92/255,92/235,1)
                        }
                        return QTheme.dark ? Qt.rgba(255/255,255/255,255/235,1) :  Qt.rgba(26/255,26/255,26/235,1)
                    }
                    MouseArea{
                        id:item_mouse
                        anchors.fill: parent
