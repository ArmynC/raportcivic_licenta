...
Item {
    ...
    property color lineColor: QTheme.dark ? Qt.rgba(111/255,111/255,111/255,1) : Qt.rgba(217/255,217/255,217/255,1)
    id:control
    QtObject {
        id:d
        property int dy
        ...
        property color hitColor: QTheme.primaryColor
    }
    onDataSourceChanged: {
        ...
        Item{
            ...
            Rectangle{
                ...
                Rectangle{
                    ...
                    color: QTheme.dark ? QColors.Black : QColors.White
                    anchors{
                        top: parent.top
                        left: parent.left
                        topMargin: -3
