...
Button{
    ...
    property string cancelText: "Anuleaza"
    property string okText: "Confirma"
    property string titleText: "Paleta culori"
    property string editText: "Modifica culoarea"
    property string redText: "Rosu"
    property string greenText: "Verde"
    property string blueText: "Albastru"
    property string opacityText: "Transparenta"
    background:
        Rectangle{
        id:layout_color
        radius: 5
        ...
        border.color: {
            ...
            return QTheme.dark ? Qt.rgba(100/255,100/255,100/255,1) : Qt.rgba(200/255,200/255,200/255,1)
        }
        border.width: 1
        Rectangle{
            anchors.fill: parent
