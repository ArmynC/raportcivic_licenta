...
Item{
    property int mode: QTimelineType.Left
    property alias model: repeater.model
    property color lineColor: QTheme.dark ? Qt.rgba(80/255,80/255,80/255,1) : Qt.rgba(210/255,210/255,210/255,1)
    id:control
    implicitWidth: 380
    implicitHeight: layout_column.height
    QtObject{
        id:d
        property bool isLeft: control.mode === QTimelineType.Left
        property bool isRight: control.mode === QTimelineType.Right
        property bool isAlternate: control.mode === QTimelineType.Alternate
