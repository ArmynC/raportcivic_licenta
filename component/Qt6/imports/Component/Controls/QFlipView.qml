...
Item{
    ...
    Button{
        ...
        background: Rectangle{
            radius: 4
            color:QTheme.dark ? Qt.rgba(45/255,45/255,45/255,0.97) : Qt.rgba(237/255,237/255,237/255,0.97)
        }
        contentItem:QIcon{
            ...
            height: 10
            iconSize: 10
            iconColor: btn_start.hovered ? QColors.Grey220  :  QColors.Grey120
    ...
    Button{
        ...
        contentItem:QIcon{
            ...
            height: 10
            iconSize: 10
            iconColor: btn_end.hovered ? QColors.Grey220  :  QColors.Grey120
            anchors.centerIn: parent
        }
        onClicked: {
