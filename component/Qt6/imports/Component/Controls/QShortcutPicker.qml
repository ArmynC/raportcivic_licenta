...
QIconButton {
    ...
    property string title: qsTr("Activeaza Shortcut-ul")
    property string message: qsTr("Apasa combinatia de taste dorita pentru a activa shortcut-ul")
    property string positiveText: qsTr("Salveaza")
    property string neutralText: qsTr("Anuleaza")
    property string negativeText: qsTr("Reseteaza")
    signal accepted()
    QtObject{
        id: d
    ...
    QContentDialog{
        ...
        buttonFlags: QContentDialogType.NegativeButton | QContentDialogType.PositiveButton | QContentDialogType.NeutralButton
