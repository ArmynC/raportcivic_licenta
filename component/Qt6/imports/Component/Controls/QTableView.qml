...
Rectangle {
    ...
    property color borderColor: QTheme.dark ? Qt.rgba(37 / 255, 37 / 255, 37 / 255, 1) : Qt.rgba(228 / 255, 228 / 255, 228 / 255, 1)
    property bool horizonalHeaderVisible: true
    property bool verticalHeaderVisible: true
    property color selectedBorderColor: QTheme.primaryColor
    property color selectedColor: QTools.withOpacity(QTheme.primaryColor, 0.3)
    id: control
    ...
    Component {
        ...
        Item {
            ...
            Flickable {
                ...
                TextArea.flickable: QMultilineTextBox {
                    id: text_box
                    text: String(display)
                    readOnly: true === d.columns_data[column].readOnly
            ...
            Rectangle {
                ...
                color: {
                    ...
                    if (d.rowHoverIndex === row || item_table.isRowSelected) {
                        return QTheme.dark ? Qt.rgba(1, 1, 1, 0.06) : Qt.rgba(0, 0, 0, 0.06)
                    }
                    return (row % 2 !== 0) ? control.color : (QTheme.dark ? Qt.rgba(1, 1, 1, 0.015) : Qt.rgba(0, 0, 0, 0.015))
                }

                // select row of table (blue color)
    ...
    MouseArea {
        ...
        TableView {
            ...
            columnWidthProvider: function (column) {
                return 220 // manually column width
            }
            rowHeightProvider: function (row) {
                return 100 // manually row height
            }
    ...
    Component {
        ...
        Rectangle {
            ...
            color: QTheme.dark ? Qt.rgba(50 / 255, 50 / 255, 50 / 255, 1) : Qt.rgba(247 / 255, 247 / 255, 247 / 255, 1)
            Rectangle {
            ...
            MouseArea {
                ...
                onPressed: mouse => {
                               QTools.setOverrideCursor(Qt.SplitHCursor)
                               clickPos = Qt.point(mouse.x, mouse.y)
                           }
                onReleased: {
                    QTools.restoreOverrideCursor()
                }
                onCanceled: {
                    QTools.restoreOverrideCursor()
                }
    ...
    Component {
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onPressed: mouse => {
                               QTools.setOverrideCursor(Qt.SplitVCursor)
                               clickPos = Qt.point(mouse.x, mouse.y)
                           }
                onReleased: {
                    QTools.restoreOverrideCursor()
    ...
    TableView {
        ...
        Connections {
            ...
            function onRowCountChanged() {
                header_row_model.rows = Array.from({
                                                       "length": table_model.rows.length
                                                   }, (_, i) => ({
                                                                     "rowIndex": i + 1
                                                                 }))
            }
