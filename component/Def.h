...
Q_ENUM_NS(Position)
QML_NAMED_ELEMENT(QSheetType)
}

namespace QThemeType {
Q_NAMESPACE
enum DarkMode {
    System = 0x0000,
    Light = 0x0001,
...
Q_ENUM_NS(DarkMode)
QML_NAMED_ELEMENT(QThemeType)
}

namespace QTimelineType {
Q_NAMESPACE
enum Mode {
    Left = 0x0000,
    Right = 0x0001,
...
Q_ENUM_NS(Mode)
QML_NAMED_ELEMENT(QTimelineType)
}
...
QML_NAMED_ELEMENT(QPageType)
}

namespace QWindowType {
Q_NAMESPACE
enum LaunchMode {
    Standard = 0x0000,
    SingleTask = 0x0001,
...
Q_ENUM_NS(LaunchMode)
QML_NAMED_ELEMENT(QWindowType)
}

namespace QTreeViewType {
Q_NAMESPACE
enum SelectionMode {
    None = 0x0000,
    Single = 0x0001,
...
QML_NAMED_ELEMENT(QTreeViewType)
}

namespace QStatusLayoutType {
Q_NAMESPACE
enum StatusMode {
    Loading = 0x0000,
    Empty = 0x0001,
...
QML_NAMED_ELEMENT(QStatusLayoutType)
}

namespace QContentDialogType {
Q_NAMESPACE
enum ButtonFlag {
...
QML_NAMED_ELEMENT(QContentDialogType)
}

namespace QTimePickerType {
Q_NAMESPACE
enum HourFormat {
    H = 0x0000,
    HH = 0x0001
...
QML_NAMED_ELEMENT(QTimePickerType)
}

namespace QCalendarViewType {
Q_NAMESPACE
enum DisplayMode {
    Month = 0x0000,
    Year = 0x0001,
...
QML_NAMED_ELEMENT(QCalendarViewType)
}

namespace QTabViewType {
Q_NAMESPACE
...
QML_NAMED_ELEMENT(QTabViewType)
}

namespace QNavigationViewType {
Q_NAMESPACE
enum DisplayMode {
    Open = 0x0000,
    Compact = 0x0001,
...
Q_ENUM_NS(PageMode)
QML_NAMED_ELEMENT(QNavigationViewType)
}
