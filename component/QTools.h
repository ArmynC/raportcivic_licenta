...
/**
 * @brief The QTools class
 */
class QTools : public QObject
{
    Q_OBJECT
    QML_NAMED_ELEMENT(QTools)
    QML_SINGLETON
private:
    explicit QTools(QObject *parent = nullptr);
public:
    SINGLETON(QTools)
    static QTools *create(QQmlEngine *qmlEngine, QJSEngine *jsEngine){return getInstance();}
