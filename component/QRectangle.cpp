...
QRectangle::QRectangle(QQuickItem* parent) : QQuickPaintedItem(parent){
    color(QColor(255,255,255,255));
    radius({0,0,0,0});
    connect(this,&QRectangle::colorChanged,this,[=]{update();});
    connect(this,&QRectangle::radiusChanged,this,[=]{update();});
}

void QRectangle::paint(QPainter* painter){
    painter->save();
