...
class QDownloadParam : public QObject{
    Q_OBJECT

public:
    explicit QDownloadParam(QObject *parent = nullptr);
    QDownloadParam(QString destPath,bool append,QObject *parent = nullptr);
...
public:
    QDownloadParam* _downloadParam = nullptr;
...
class Network : public QObject, public Singleton<Network> {
    Q_OBJECT
...
private:
    ...
    friend class Singleton<Network>; // permit singleton access into protected
