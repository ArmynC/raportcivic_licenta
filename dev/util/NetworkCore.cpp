...
QDownloadParam::QDownloadParam(QObject *parent)
    : QObject{parent}
{
}

QDownloadParam::QDownloadParam(QString destPath,bool append,QObject *parent)
    : QObject{parent}
{
...
NetworkParams* NetworkParams::toDownload(QString destPath,bool append){
    _downloadParam = new QDownloadParam(destPath,append,this);
    return this;
}
